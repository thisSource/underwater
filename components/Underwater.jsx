...
const Underwater = (props) => {
  ...
  return (
    <div className="">
      <p className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 lg:text-12xl text-10xl lg:opacity-100 text-yellow-500 font-Salty drop-shadow-[0_15px_35px_rgba(255,255,255)]">
        Tjärö
      </p>
      <p className="absolute top-2/3 left-1/2 transform -translate-x-1/2 -translate-y-1/2 lg:text-5xl text-5xl lg:opacity-100 text-yellow-500 font-Salty drop-shadow-[0_15px_35px_rgba(255,255,255)]">
        PLX 2022
      </p>
      <button
